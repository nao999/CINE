...
var JSON3 = require('json3')
  , iframeUtils = require('./store/iframe')
  ;
...
var urlUtils = require('./store/url')
  , eventUtils = require('./store/event')
  , JSON3 = require('json3')
...
var EventEmitter = require('events').EventEmitter
  ...
  , JSON3 = require('json3')
  , objectUtils = require('./store/object')
  ;
...
var URL = require('url-parse')
  , inherits = require('inherits')
  , JSON3 = require('json3')
  , random = require('./store/random')
  , escape = require('./store/escape')
  , urlUtils = require('./store/url')
  , eventUtils = require('./store/event')
  , transport = require('./store/transport')
  , objectUtils = require('./store/object')
  , browser = require('./store/browser')
  , log = require('./store/log')
...
var utils = require('../../store/iframe')
  , random = require('../../store/random')
  , browser = require('../../store/browser')
  , urlUtils = require('../../store/url')
  , inherits = require('inherits')
...
var random = require('../../store/random')
  , urlUtils = require('../../store/url')
  ;
...
var debug = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug = require('debug')('sockjs-client:store:iframe');
}
...
var debug = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug = require('debug')('sockjs-client:store:transport');
}
...
var debug = function() {};
if (process.env.NODE_ENV !== 'production') {
  debug = require('debug')('sockjs-client:store:url');
}
